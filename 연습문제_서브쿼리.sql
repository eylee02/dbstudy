...
-- 5. 평균 근속 개월 수 이상을 근무한 사원을 조회하시오.     -- 안나옴
-- 근속 개월수 구하기
-- 근속 개월수 평균값
-- 평균값 이상 사원
...
SELECT EMP_NO, NAME, DEPT_NO, GENDER, POSITION, HIRE_DATE, SALARY
  FROM EMPLOYEE_T
...
SELECT RN , EMP_NO, NAME, DEPT_NO, POSITION, GENDER, HIRE_DATE, SALARY
  FROM (SELECT ROW_NUMBER() OVER(ORDER BY HIRE_DATE ASC) AS RN ,EMP_NO, NAME, DEPT_NO, POSITION, GENDER, HIRE_DATE, SALARY
          FROM EMPLOYEE_T)
