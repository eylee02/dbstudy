...
CREATE TABLE DEPARTMENT_TBL(
    ...
    CONSTRAINT PK_DERT PRIMARY KEY(DEPT_NO)
);
...
CREATE TABLE EMPLOYEE_TBL(
    ...
    CONSTRAINT FK_DEPT_EMP FOREIGN KEY(DEPT_NO) REFERENCES DEPARTMENT_TBL(DEPT_NO) ON DELETE SET NULL --부서가 삭제되면 사원들의 해당 부서정보만 NULL 처리
);
...
--프로젝트진행테이블(예제변형 EMP,PJT NOT NULL추가)
