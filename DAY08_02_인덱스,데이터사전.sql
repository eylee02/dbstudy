/*
    ...
    2. 어떤 행이 어디에 저장되어 있는지 알고있는 칼럼이다.
    3. 실제 저장된 물리적 저장위치를 확인 할 수 있다.
*/
...
SELECT *
  FROM EMPLOYEES
 WHERE ROWID = 'AAAR+vAAHAAAADMAAE';
...
/*
    ...
    4. 인덱스가 많으면 데이터의 삽입/수정/삭제시 인덱스도 함께 갱신해야 하기 때문에 전체적인 성능이 떨어질 수 있다.
*/
...
SELECT *
  FROM USER_INDEXES;   -- 현재 계정이 보유한 데이터조회
