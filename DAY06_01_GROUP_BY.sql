...
-- 5. 사원 테이블에서 각 부서별 사원수를 조회하시오. 단 부서번호가 없는 사원은 제외하시오. (부서번호가 없는 사원은 WHERE 절로 확인가능,HAVING절을 사용하지않음)
-- 조건 : 부서번호 IS NOT NULL
...
SELECT DEPARTMENT_ID
 ...
 GROUP BY DEPARTMENT_ID
--HAVING DEPARTMENT_ID IS NOT NULL;  -- 동작은 하지만 성능이 떨어짐
